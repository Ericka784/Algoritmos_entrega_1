...
# ╔═╡ f064aedb-2c36-47f3-b461-23fccb1a06c6
md"La nariz del michi se puede visualizar cuando el rango columnas está en 194-322 y en el rango de renglones 161-279, en el siguiente link esta la imagen de la nariz del michi  https://drive.google.com/file/d/1EZoa79SwLpBnrZwd7jUdBiSeWXJq8Hpp/view?usp=sharing ( también está en la carpeta del segundo modulo con el nombre narizmichi.png)"
...
# ╔═╡ 744b1940-e71d-4f41-9834-88d869bfd9c0
arte_de_pixeles = [RGB(0.0, 0.75, 1.0)  RGB(0.0, 0.75, 1.0)  RGB(0.0, 0.75, 1.0)  RGB(0.0,0.0,0.0)  RGB(0.23, 0.23, 0.23)  RGB(0.23, 0.23, 0.23)  RGB(0.0, 0.75, 1.0)  RGB(0.0, 0.75, 1.0)
 RGB(0.0, 0.75, 1.0)  RGB(0.0, 0.75, 1.0)  RGB(0.0,0.0,0.0)  RGB(0.23, 0.23, 0.23)  RGB(0.0,0.0,0.0)  RGB(1.0, 1.0, 1.0)  RGB(0.0,0.0,0.0)  RGB(0.0, 0.75, 1.0)
 RGB(0.0, 0.75, 1.0)  RGB(0.0, 0.75, 1.0)  RGB(0.0,0.0,0.0)  RGB(0.23, 0.23, 0.23)  RGB(0.8, 0.8, 0.8)  RGB(1.0, 0.84, 0.0)  RGB(1.0, 1.0, 1.0)  RGB(0.0, 0.75, 1.0)
 RGB(0.0, 0.75, 1.0)  RGB(0.0, 0.75, 1.0)  RGB(0.0,0.0,0.0)  RGB(0.23, 0.23, 0.23)  RGB(0.23, 0.23, 0.23)  RGB(0.0,0.0,0.0)  RGB(0.23, 0.23, 0.23)  RGB(0.0, 0.75, 1.0)
 RGB(0.0, 0.75, 1.0)  RGB(0.0,0.0,0.0)  RGB(0.23, 0.23, 0.23)  RGB(0.8, 0.8, 0.8)  RGB(0.8, 0.8, 0.8)  RGB(1.0, 1.0, 1.0)  RGB(1.0, 1.0, 1.0)  RGB(0.0,0.0,0.0)
 RGB(0.0, 0.75, 1.0)  RGB(0.0,0.0,0.0)  RGB(0.23, 0.23, 0.23)  RGB(0.8, 0.8, 0.8)  RGB(0.8, 0.8, 0.8)  RGB(1.0, 1.0, 1.0)  RGB(1.0, 1.0, 1.0)  RGB(0.0,0.0,0.0)
 RGB(0.0, 0.75, 1.0)  RGB(0.0,0.0,0.0)  RGB(0.23, 0.23, 0.23)  RGB(0.8, 0.8, 0.8)  RGB(0.8, 0.8, 0.8)  RGB(0.8, 0.8, 0.8)  RGB(1.0, 1.0, 1.0)  RGB(0.0,0.0,0.0)
RGB(0.0, 0.75, 1.0)  RGB(0.0, 0.75, 1.0)  RGB(0.0,0.0,0.0)  RGB(0.23, 0.23, 0.23)  RGB(1.0, 0.84, 0.0)  RGB(0.23, 0.23, 0.23)  RGB(1.0, 0.84, 0.0)  RGB(0.0, 0.75, 1.0)]
...
save("narizmichi.png",nariz)

# ╔═╡ 648f426b-4838-4d83-a4e7-f25fb1ee22fb
save("arte_de_pixeles.png",arte_de_pixeles)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "f51c64288773447b4b9f398b5228c221c8c784e0"
